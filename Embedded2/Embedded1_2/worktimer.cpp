...
void WorkTimer::CalcMotorPosition()
{
    ...
    Matrix<double,7,1> PosMetric_dot;
    Matrix<double,1,6> J_phi,J_1qx,J_1qy,J_L,J_2qx,J_2qy;

    J_phi<<1<<0<<0<<0<<0<<0;

    J_1qx<<0<< Space_R*cos(q_c(2))<< -(q_c(1)-PI/2)*Space_R*sin(q_c(2))<< 0<<0<<0;
