...
class MPU6000 : public QObject
{
    Q_OBJECT
public:
    explicit MPU6000(QObject *parent = 0);
    ~MPU6000();
    void SPI_Init();
    __u8 MPU6000_ReadREG(__u8 RREG);
    __u16 MPU6000_Read2Bytes(__u8 Reg_H,__u8 Reg_L);
    void MPU6000_WriteREG(__u8 WriteREG,__u8 WriteValue);
    void MPU6000_Init();
private:
    int fd;
